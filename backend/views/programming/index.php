...
$this->title = \Yii::t('app', 'Programming Languge');
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="genres-index">
    <div class="row">
        <div class="col-md-4 col-sm-4 col-xs-12">
            <h4><?= \Yii::t('app', 'Add New Programming Languge') ?> </h4>
            <?php
            ...
            GridView::widget([
                ...
                'columns'      => [
                    ...
                    [
                        ...
                        'value'     => function($data)
                        {
                            return '<input type="number" class="form-control" style="width:60px" name=order[' . $data->id . '] value="' . $data->order . '">';
                        },
                    ],
                    [
                        'attribute' => 'title',
