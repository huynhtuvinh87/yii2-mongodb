...
$this->title = 'Xem CV';
$this->params['breadcrumbs'][] = ['label' => 'Danh sách công việc đã apply', 'url' => ['index']];
$this->params['breadcrumbs'][] = $this->title;
?>
<section class="page job-bg ad-profile-page" style="max-width: 980px">
    <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-9">    
                        <div class="profile-logo">
                            <img class="img-responsive" src="<?= $model->photo() ?>" alt="Image" style="max-width: 150px; min-width: 150px">
                        </div>
                        <div class="profile-info">
                            <h1><?= $model->name ?></h1>
                            <address>
                                <p><?= nl2br($model->information) ?></p>
                            </address>
                        </div>	
                    </div>
                    <div class="col-lg-3">
                        <div class="download-button" style="margin-top: 50px">
                            <?= Html::a('Chỉnh sửa', ['update', 'id' => $model->id], ['class' => 'btn btn-danger']) ?>
                            <?= Html::a('Xuất PDF', ['pdf'], ['class' => 'btn btn-primary']) ?>
                        </div>
                    </div>
                </div>
            </div>
