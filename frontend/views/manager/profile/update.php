        ...
        <div class="profile job-profile">
            <div class="user-pro-section">
                ...
                <div class="profile-details section">
                    ...
                    <div class="row form-group field-profilemember-avatar">
                        <label class="col-sm-3 label-title" for="profilemember-avatar"><?= $profile->getAttributeLabel('avatar') ?></label>
                        <div class="col-sm-9">
                            <label for="avatar">
                                <?= Html::fileInput('ProfileMember[avatar]', '', ['style' => 'display:none', 'id' => 'avatar']) ?>
                    ...
                    ?>
                    <div class="row form-group field-profilemember-birthday">
                        <label class="col-sm-3 label-title" for="profile-birthday"><?= $profile->getAttributeLabel('birthday') ?></label>
                        <div class="col-sm-9">
                            <?= Html::dropDownList('ProfileMember[day]', $profile->day, $profile->days) ?>
                            <?= Html::dropDownList('ProfileMember[month]', $profile->month, $profile->months) ?> 
                            <?= Html::dropDownList('ProfileMember[year]', $profile->year, $profile->years) ?>
                        </div>
                    </div>
                    <div class="row form-group field-profilemember-gender">
                        <label class="col-sm-3 label-title" for="profilemember-gender"><?= $profile->getAttributeLabel('gender') ?></label>
                        <div class="col-sm-9">
                            <?= Html::dropDownList('ProfileMember[gender]', $profile->gender, [1 => 'Nam', 2 => 'Nữ']) ?>
                        </div>
                    </div>
                    <?=
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-sm-9">
                            <?= Html::dropDownList('ResumeForm[gender]', $profile->city, $profile->cities, ['class' => 'form-control']) ?>
                        </div>
                    </div>
                    <?=
