            ...
            foreach ($model->language as $k => $value)
            {
                ...
                <div style=" overflow: hidden; margin-top: 20px">
                    <div class="row form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="ResumeForm[language_name][]" class="form-control" value="<?= $value['language_name'] ?>">
                        </div>
                    </div>
                    <div class="row form-group rating">
                        <label class="col-sm-3 label-title">Cấp độ</label>
                        <div class="col-sm-9">
                            <input type="text" name="ResumeForm[language_level][]" class="form-control" value="<?= $value['language_level'] ?>">
                        </div>
                    </div>
        ...
        } else
        {
            ...
            <div style=" overflow: hidden; margin-top: 20px">
                <div class="row form-group">
                    <label class="col-sm-3 label-title">Tên</label>
                    <div class="col-sm-9">
                        <input type="text" name="ResumeForm[language_name][]" class="form-control" placeholder="English">
                    </div>
                </div>
                <div class="row form-group rating">
                    <label class="col-sm-3 label-title">Cấp độ</label>
                    <div class="col-sm-9">
                        <input type="text" name="ResumeForm[language_level][]" class="form-control">
                    </div>
                </div>
                <div class="pull-right">
                    <a href="javascript:void(0)" class="btn btn-danger language-delete">Xóa</a>
